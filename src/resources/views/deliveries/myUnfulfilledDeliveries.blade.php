@extends('seat-industry::deliveries.layout.main', ['viewname' => 'myUnfulfilledDeliveries'])
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-text pt-3">
                @include("seat-industry::deliveries.partials.deliveryTable",["deliveries.blade.php"=>$deliveries,"showOrder"=>true])
            </div>
        </div>
    </div>
@stop
