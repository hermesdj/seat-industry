    ...
    <div class="col-4">
        @include('seat-industry::statistics.partials.scores.display-score-table',
            [
                ...
                'rows' => $producersCountQuery->clone()->where('completed_at', '>', \Carbon\Carbon::now()->subDays(30)->endOfDay())->get()
            ]
        )
    </div>
    <div class="col-4">
        @include('seat-industry::statistics.partials.scores.display-score-table',
            [
                ...
                'rows' => \Seat\HermesDj\Industry\Helpers\StatsHelper::displayTimeValueAsHumanReadable($producersMeanTimeQuery->clone()->where('completed_at', '>', \Carbon\Carbon::now()->subDays(30)->endOfDay())->get())
            ]
        )
    </div>
    <div class="col-4">
        @include('seat-industry::statistics.partials.scores.display-score-table',
            [
                ...
                'rows' => \Seat\HermesDj\Industry\Helpers\StatsHelper::displayTimeValueAsHumanReadable($fastestProducerQuery->clone()->where('completed_at', '>', \Carbon\Carbon::now()->subDays(30)->endOfDay())->get())
            ]
        )
    </div>
</div>