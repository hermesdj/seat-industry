@extends('seat-industry::orders.layout.main', ['viewname' => 'myOrders'])

@section('orders_content')
    <div class="card">
        <div class="card-body p-2">
            <h5 class="card-header d-flex flex-row align-items-baseline">
                {{trans('seat-industry::ai-orders.list.titles.my')}}
            ...
            <div class="card-text pt-3">
                @include("seat-industry::orders.partials.orderTable",["orders"=>$orders, "displayStatus" => true])
            </div>
        </div>
    </div>
@endsection
